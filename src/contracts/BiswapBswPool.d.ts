...
interface BiswapBswPoolInterface extends ethers.utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    functionFragment: "updateBswPerBlock",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class BiswapBswPool extends BaseContract {
  ...
  interface: BiswapBswPoolInterface;
